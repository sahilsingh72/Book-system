                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.admins.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            {{-- Assign under --}}
                            <div class="form-group col-md-6 col-sm-6">
                                <label for="assign_under">Assign Under (one time use)</label>
                                <select name="assign_under" id="assign_under" class="form-control select2" required>
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                <label for="username">Admin Username (one time use)</label>
